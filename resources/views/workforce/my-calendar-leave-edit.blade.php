...
<div class="mx-auto max-w-xl">
    ...
    <form method="POST" action="{{ route('my-calendar.leave.update', $leave) }}" class="card grid gap-4 p-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-3"><a href="{{ route('my-calendar.index') }}" class="btn-secondary">Cancel</a><button class="btn-primary">Save Changes</button></div>
    </form>
</div>
@endsection
