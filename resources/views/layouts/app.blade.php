        ...
        <nav class="relative h-[calc(100vh-7rem)] overflow-y-auto px-5 py-5 text-sm [scrollbar-width:thin] [scrollbar-color:rgba(34,211,238,.25)_transparent]">
            ...
            <div class="space-y-1">
                ...
                @foreach(config('crm.navigation') as $group => $items)
                    @php
                        $resources = ['customers', 'brands', 'departments', 'machine-categories', 'machines', 'technicians', 'skills', 'amc-plans', 'service-requests', 'assignments', 'job-cards', 'work-status', 'service-reports', 'parts', 'suppliers', 'inventory', 'parts-issues', 'job-parts', 'parts-requests'];
