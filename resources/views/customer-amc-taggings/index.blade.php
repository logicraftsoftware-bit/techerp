...
<div class="card overflow-x-auto">
    <table class="w-full text-left text-sm">
        <thead class="bg-slate-50 text-xs uppercase text-slate-500"><tr><th class="p-4">Customer</th><th class="p-4">Machine</th><th class="p-4">AMC Plan</th><th class="p-4">Start Date</th><th class="p-4">End Date</th><th class="p-4">Status</th>@if($isAdmin)<th class="p-4 text-right">Actions</th>@endif</tr></thead>
        ...
        @empty
            <tr><td colspan="{{ $isAdmin ? 7 : 6 }}" class="p-12 text-center text-slate-400">No Customer-AMC taggings found.</td></tr>
        @endforelse
        </tbody>
    </table>
