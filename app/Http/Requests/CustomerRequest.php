...
class CustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'customer_code' => ['required', 'max:50', Rule::unique('customers')->ignore($id)], 'customer_type' => ['required', Rule::in(['individual', 'company', 'government'])], 'customer_name' => ['required', 'max:150'], 'company_name' => ['nullable', 'max:150'], 'contact_person' => ['nullable', 'max:120'],
