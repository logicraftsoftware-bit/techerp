...
class TechnicianRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'salary_type' => ['required', Rule::in(['monthly', 'daily'])], 'monthly_salary' => ['nullable', 'required_if:salary_type,monthly', 'numeric', 'min:0'], 'daily_salary' => ['nullable', 'required_if:salary_type,daily', 'numeric', 'min:0'], 'overtime_rate' => ['nullable', 'numeric', 'min:0'], 'travel_allowance' => ['nullable', 'numeric', 'min:0'], 'food_allowance' => ['nullable', 'numeric', 'min:0'], 'other_allowance' => ['nullable', 'numeric', 'min:0'], 'pf' => ['nullable', 'numeric', 'min:0'], 'esi' => ['nullable', 'numeric', 'min:0'], 'skills' => ['nullable', 'array'], 'skills.*' => ['exists:skills,id'],
        ];
    }
}
