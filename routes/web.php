...
use App\Http\Controllers\SelfCalendarController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::post('/my-calendar/check-in', [SelfCalendarController::class, 'checkIn'])->name('my-calendar.check-in');
    Route::post('/my-calendar/check-out', [SelfCalendarController::class, 'checkOut'])->name('my-calendar.check-out');
    Route::post('/my-calendar/leave', [SelfCalendarController::class, 'storeLeave'])->name('my-calendar.leave.store');
    Route::get('/my-calendar/leave/{leave}/edit', [SelfCalendarController::class, 'editLeave'])->name('my-calendar.leave.edit');
    Route::put('/my-calendar/leave/{leave}', [SelfCalendarController::class, 'updateLeave'])->name('my-calendar.leave.update');
    Route::delete('/my-calendar/leave/{leave}', [SelfCalendarController::class, 'destroyLeave'])->name('my-calendar.leave.destroy');
    ...
    Route::resource('commission-types', CommissionTypeController::class)->except('show');
    ...
    Route::get('/leave/{leave}/edit', [WorkforceController::class, 'editLeave'])->name('leave.edit');
    Route::put('/leave/{leave}/details', [WorkforceController::class, 'updateLeaveDetails'])->name('leave.update-details');
    Route::delete('/leave/{leave}', [WorkforceController::class, 'destroyLeave'])->name('leave.destroy');
